...
//		Na kraju programa ugasite pretrazivac.
		...
		for (int i = 0; i < 5; i++) {
			...
			driver.findElement(By.name("name")).sendKeys("Zoran Pavlovic");
			driver.findElement(By.name("department")).sendKeys("Software QA");
			driver.findElement(By.name("phone")).sendKeys("(404) 654-8843");
			driver.findElement(By.xpath("//*[@class='table table-bordered']/tbody/tr[last()]"))
					.findElement(By.className("add")).click();
			Thread.sleep(500);
		}
		driver.quit();
	}
